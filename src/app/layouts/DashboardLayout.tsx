          ...
          <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-4">
              ...
              <p className="text-neutral-400 text-[10px] font-black uppercase tracking-widest">
                © 2026 SustainAIM Dashboard • Environment OS v4.5.0
              </p>
            </div>
            <div className="flex items-center gap-10">
              <Link to="/dashboard/security" className="text-[10px] font-black text-neutral-400 hover:text-emerald-600 uppercase tracking-widest transition-colors">
                Security
              </Link>
              <Link to="/dashboard/documentation" className="text-[10px] font-black text-neutral-400 hover:text-emerald-600 uppercase tracking-widest transition-colors">
                Documentation
              </Link>
              <Link to="/dashboard/api-status" className="text-[10px] font-black text-neutral-400 hover:text-emerald-600 uppercase tracking-widest transition-colors">
                API Status
              </Link>
              <Link to="/dashboard/privacy" className="text-[10px] font-black text-neutral-400 hover:text-emerald-600 uppercase tracking-widest transition-colors">
                Privacy
              </Link>
            </div>
          </div>
